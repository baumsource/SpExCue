function [trl, event] = ft_trialfun_SpExCue_EEGpilot(cfg)

% ft_trialfun_SpExCue_EEGpilot searches for events
...
chanindx    = strmatch('A1', hdr.label);
 
% read all data of the EMG channel, assume continuous file format
begsample = 1;
endsample = hdr.nSamples*hdr.nTrials;
a1       = ft_read_data(cfg.datafile, 'begsample', begsample, 'endsample', endsample, 'chanindx', chanindx);
