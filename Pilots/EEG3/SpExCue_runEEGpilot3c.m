...
switch procedure{1}
  ...
  case 'familiarization'
    ...
    Nrep = 6;
    fnExtension = 'famili';
    SpExCue_EEGpilot3(ID,'M',[1,0],'azi',[90,0],'Nrep',Nrep,...
  ...
  case 'behavioral'
    ...
    fnExtension = 'behav';%'behav';
    
    SpExCue_EEGpilot3(ID,'azi',[90,0],'M',[1,.5,0],'Nrep',Nrep,... %-90:90:90
  ...
  case 'eeg'
    ...
    fnExtension = 'eeg';
    SpExCue_EEGpilot3(ID,'azi',90,'M',[1,.5,0],'Nrep',Nrep,...
      'D0detectionFeedback','repeateM','skipFamiliarization','noRoving',...
      'screenNumber',1,'fnExtension',fnExtension,'HRCeq')
