function tab = SpExCue_Exp2a_screening( ID,varargin )
%SpExCue_Exp2a_screening - Screening to assess affected dimensionality by changes
...
infotext = [...
  ...
  '   Press *spacebar* multiple times to play the same sound and answer the following question! \n\n \n\n \n\n',...
