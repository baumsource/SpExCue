function SpExCue_Exp2(ID,varargin)
%SpExCue_Exp2 - Experimental routine for experiment II of the 
...
% Add KEMAR as M = pi
kemar = SpExCue_stim( 1,'KEMAR',pos,round(fs),'argimport',flags,kv );
subj.stim.sig = cat(1,subj.stim.sig,kemar.sig);
kv.M = cat(1,kv.M(:),pi);
