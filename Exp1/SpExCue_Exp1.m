function SpExCue_Exp1(ID,varargin)
%SpExCue_Exp1 - Experimental routine for experiment I of the 
...
instruction1 = [...
  ...
  'SPATIAL LOCATION and try to ignore other differences like intensity or pitch. \n',...
  ...
  '  Press *C* if the SECOND sound appears to be CLOSER than the first sound or\n'];
if flags.do_repeateM
  instruction1 = [instruction1,...
  '  press *F* if the SECOND sound appears to be FARTHER than the first sound or\n',...
  '  press *SPACEBAR* if the sound does not change at all (catch trial).\n'];
else
  instruction1 = [instruction1,...,...
  '  press *F* if the SECOND sound appears to be FARTHER than the first sound.\n'];
end
instruction1 = [instruction1,...
  '\n',...
